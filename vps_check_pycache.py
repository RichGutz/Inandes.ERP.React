...
def main():
    print("=== LISTANDO CONTENIDO DE __pycache__ EN EL VPS ===")
    ...
    cmd = "ls -lh /opt/erp_inandes/CRM_Inandes/scripts_cuotas/__pycache__/ 2>/dev/null"
    stdin, stdout, stderr = client.exec_command(cmd)
    res = stdout.read().decode('utf-8', errors='replace')
    print("\n--- Contenido de __pycache__ ---")
    print(res)
