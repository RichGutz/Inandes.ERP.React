...
def generate_pdf_v_integral_v19():
    # Versión 19: Feedback Loop de Capitalización (SÍ -> Aumento Capital)
    # Basado en V18, evolucionando para mapear con motores reales V40/V25/V2
    base_name = "version_flujo_crm_06.03.26_integral_v19"
    
    output_filename = base_name
    
    print(f"Generando Version Integral CRM V19: {output_filename}.pdf")
    ...
    digraph CRMLogicIntegralV19 {
        ...
        # ==========================================
        #  NIVEL 2: MÓDULO DE CONTRATOS Y NACIMIENTO
        # ==========================================
        ...
        # ==========================================
        #  NIVEL 3: OPERACIÓN DUAL (V19 FEEDBACK LOOP)
        # ==========================================
        subgraph cluster_lvl3 {
            ...
            subgraph cluster_dual_motors {
                ...
                subgraph cluster_motor_fondo {
                    label = "A: MOTOR FONDO (NAV)\\n(generate_cuotas_v25.py)"; style="filled"; fillcolor="#E3F2FD"; color="#1E88E5";
                    NavCalc [label="{DIARIO FONDO|1. Patrimonio Inicial\\n2. Rendimiento Bruto\\n3. (-) Comisiones\\n4. (=) VALOR CUOTA}", shape=record, fillcolor="white"];
                }

                # MOTOR B: CERTIFICADO (V19 CORRECT FEEDBACK)
                subgraph cluster_motor_cert {
                    label = "B: MOTOR CERTIFICADO (P&L)\\n(CALCULO_Retornos_Intereses_v40.py)"; style="filled"; fillcolor="#F3E5F5"; color="#9C27B0";
                ...
                # MOTOR C: ASESORES (V2)
                subgraph cluster_motor_asesor {
                    label = "C: MOTOR ASESORES\\n(generate_comisiones_asesores_v2.py)"; style="filled"; fillcolor="#E0F7FA"; color="#006064";
                    ComisionesCalc [label="{PROYECCIÓN COMISIONES|1. Monto de Inversión\\n2. Tasa de Comisión\\n3. (=) Comisión Proyectada}", shape=record, fillcolor="white"];
                }
            }
        }

        # ==========================================
        #  NIVEL 4: OUTPUTS INTEGRADOS
        # ==========================================
        subgraph cluster_outputs {
            label = "NIVEL 4: OUTPUTS Y IA (FINAL)"; style="filled,dashed"; fillcolor="#ECEFF1"; color="#607D8B";
            Orquestador [label="⚙️ ORQUESTADOR DE REPORTES\\n(ORQUESTADOR_Reportes_Batch_Integrado.py)", shape=component, fillcolor="#B3E5FC", penwidth=2];
        ...
        # Conexión Asesores -> Motor C
        Advisor -> ComisionesCalc [style=dashed, color="#006064", constraint=false];
        ...
        ComisionesCalc -> Orquestador [color="#006064"];
