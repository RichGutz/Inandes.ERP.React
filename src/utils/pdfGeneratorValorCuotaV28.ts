...
/**
 * Generador Oficial de Reporte PDF para Valor Cuota NAV V28
 ...
 */
export function generatePdfValorCuotaV28(options: VcPdfOptions): string {
        ...
        pagesHtml.push(`
          <div class="report-page">
            ...
            <table class="top-header-table">
              <tr>
                ...
                <td class="text-center" style="vertical-align: middle;">
                  <div class="report-main-title">REPORTE MAESTRO DE VALOR CUOTA NAV V28</div>
                  <div class="report-sub-title">Período: ${block.monthName.toUpperCase()} (${fStart} al ${fEnd}) · Año ${anio} · P&L Operativo = 0.00</div>
                </td>
            ...
            <div class="fund-badge-banner">
              FONDO ${f.nombre_fondo || f.id_fondo} (${f.id_fondo}) — MONEDA: ${moneda} &nbsp;|&nbsp; TASA ACTIVA IMPLÍCITA: ${rep.vars.activa}% &nbsp;|&nbsp; COM. ADMIN: ${rep.vars.admin}%${chunk.parteStr}
            </div>
            ...
            <div class="page-footer">
              <div style="display: table-cell; text-align: left;">InAndes ERP &copy; 2026 &mdash; Sistema de Gestión de Inversiones y Valor Cuota NAV V28 (P&L = 0)</div>
  ...
  return `
    ...
    <html lang="es">
      <head>
        <meta charset="UTF-8">
        <title>REPORTE MAESTRO DE VALOR CUOTA NAV V28</title>
        <style>
          @page {
            size: A4 landscape;
