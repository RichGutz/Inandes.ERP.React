...
def main():
    print("=== ENCONTRANDO SCRIPTS DE CUOTAS Y COMISIONES ===")
    ...
    cmd = "ls -lh /opt/erp_inandes/CRM_Inandes/scripts_cuotas/ 2>/dev/null"
    stdin, stdout, stderr = client.exec_command(cmd)
    res = stdout.read().decode('utf-8', errors='replace')
    print("\n--- Contenido de scripts_cuotas/ ---")
    print(res)
