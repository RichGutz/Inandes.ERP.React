...
def generate_perfil_operacion_pdf(invoices_data: List[Dict[str, Any]]) -> Optional[bytes]:
    """
...
def generate_efide_report_pdf(invoices_data: List[Dict[str, Any]], signatory_data: Dict[str, Any]) -> Optional[bytes]:
    """
...
def generate_lote_report_pdf(report_data: Dict[str, Any]) -> Optional[bytes]:
    """
...
def generate_liquidacion_consolidada_pdf(report_data: Dict[str, Any]) -> Optional[bytes]:
    """
...
def generar_anexo_liquidacion_pdf(invoices_data: List[Dict[str, Any]], bank_info: Dict[str, str] = None) -> Optional[bytes]:
    """
...
@measure_latency(source="MiniERP", destination="PDF Engine", operation_name="Gen. Liquidación Univ. PDF")
def generate_liquidacion_universal_pdf(resultados_liquidacion: List[Dict[str, Any]], facturas_originales: List[Dict[str, Any]]) -> Optional[bytes]:
    """
...
@measure_latency(source="MiniERP", destination="PDF Engine", operation_name="Gen. Voucher Transf. PDF")
...
def generate_reporte_cupones_pdf(report_data: Dict[str, Any]) -> Optional[bytes]:
    """
    Generates the 'Reporte de Simulación de Cupones' PDF and returns it as bytes.
    """
    return _generate_pdf_in_memory("reporte_cupones.html", report_data)
